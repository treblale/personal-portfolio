    ...
    <Section>
      <div className="w-full min-h-screen flex flex-row justify-center items-center relative">
        <div className="flex flex-col justify-center items-center px-16 lg:px-32">
          <h1 className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-purple-400 via-indigo-200 text-4xl lg:text-9xl animate-gradient-x">
            Albert Le
          </h1>
          <h1 className="text-light text-xs lg:text-xl tracking mb-8 lg:mb-12">
